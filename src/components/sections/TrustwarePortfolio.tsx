      ...
      <div className="max-w-7xl w-full space-y-24">
        ...
        <div className="portfolio-header space-y-8 text-center max-w-3xl mx-auto">
          ...
          <h2 className="t-headline text-6xl md:text-8xl text-ink leading-[0.9] tracking-tighter">
            Portfólio de <br />
            <span className="italic">Impacto</span>
          </h2>
        ...
        <div className="portfolio-grid grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-full md:min-h-[650px]">
          ...
          <div className="bento-item md:col-span-2 md:row-span-2 bg-white/40 backdrop-blur-md border border-ink/5 p-12 flex flex-col justify-between group hover:bg-obsidian transition-all duration-700 relative overflow-hidden">
            <div className="space-y-6 relative z-10">
              <span className="t-mono text-[11px] text-emerald group-hover:text-emerald-hover transition-colors uppercase tracking-[0.2em]">Vertical: Legal Tech</span>
              ...
              <h3 className="t-headline text-6xl text-ink group-hover:text-parchment-text transition-colors">{PRODUCTS[0].title}</h3>
            ...
            <div className="flex items-center justify-between relative z-10">
              <span className="t-mono text-[10px] text-emerald group-hover:text-emerald-hover tracking-widest">{PRODUCTS[0].tag}</span>
          ...
          {/* SILENT OPERATOR (2x1) */}
          <div className="bento-item md:col-span-2 bg-white/30 backdrop-blur-md border border-ink/5 p-12 flex flex-col justify-between group hover:bg-obsidian transition-all duration-700 relative overflow-hidden">
             <div className="flex justify-between items-start relative z-10">
               <div className="space-y-2">
                 <h3 className="t-headline text-4xl text-ink group-hover:text-parchment-text transition-colors">{PRODUCTS[1].title}</h3>
          ...
          {/* AGENT FORGE (1x1) */}
          <div className="bento-item bg-white/30 backdrop-blur-md border border-ink/5 p-12 flex flex-col justify-between group hover:bg-obsidian transition-all duration-700 relative overflow-hidden">
             <h3 className="t-headline text-3xl text-ink group-hover:text-parchment-text transition-colors leading-none">{PRODUCTS[2].title}</h3>
          ...
          {/* SOVEREIGN VAULT (1x1) */}
          <div className="bento-item bg-white/30 backdrop-blur-md border border-ink/5 p-12 flex flex-col justify-between group hover:bg-obsidian transition-all duration-700 relative overflow-hidden">
             <h3 className="t-headline text-3xl text-ink group-hover:text-parchment-text transition-colors leading-none">{PRODUCTS[3].title}</h3>
