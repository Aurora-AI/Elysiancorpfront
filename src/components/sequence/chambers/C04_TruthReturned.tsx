...
export function C04_TruthReturned() {
  ...
  return (
    ...
    >
      <div className="absolute left-[8%] top-1/2 -translate-y-1/2 max-w-[480px] space-y-[21px]">
        ...
        <p className="t-editorial text-[21px] leading-relaxed" style={{ color: 'rgba(26,26,23,0.7)', maxWidth: '440px' }}>
      ...
      {/* Right: product cards */}
      <div className="absolute right-[8%] top-1/2 -translate-y-1/2 flex flex-col gap-[21px]" style={{ width: '340px' }}>
        {PRODUCTS.map((p, i) => (
          <div
            key={p.name}
